...
#sort a{text-decoration:none;color:#000000;font-size: 25px;}
  ...
  <%
    ...
    <div id="sort1">
   <table border="1px">
    <tr><td>商品编号</td><td>购买数量</td><td>收货人</td><td>收货地址</td><td>联系电话</td><td>操作</td></tr>
     <%while(rs.next()){
     out.print("<tr><td>"+rs.getString(1)+"</td><td>"+rs.getInt(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(4)+"</td><td>"+rs.getString(5)+"</td><td><a href='update2.jsp?num="+rs.getString(1)+"&proname="+rs.getString(2)+"'>修改</a> <a href='delete2.jsp?num="+rs.getString(1)+"'>删除</a></td></tr>");
    } %>
     </table></div>
   <%  rs.close();
    st.close();
